...
// Takes two strings as input and returns a new string that is the combination of both.
// Parameters:
//   str1: The first string to concatenate.
//   str2: The second string to concatenate.
// Returns:
//   A pointer to a newly allocated string that contains the concatenation of str1 and str2.
//   Returns NULL if an input is NULL or if memory allocation fails.
char *concatenateStrings(const char *str1, const char *str2)
{
    // Validate input pointers to ensure they are not NULL.
    if (str1 == NULL || str2 == NULL)
    {
        return NULL; // Return NULL to indicate an error if any input is NULL.
    }

    // Calculate the total length needed for the new string, including space for the null terminator.
    ...
    // Append the second string to the end of the first string in the result.
    strcat(result, str2);
